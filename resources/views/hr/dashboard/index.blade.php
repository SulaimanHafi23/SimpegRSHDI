        ...
        <div class="md:hidden divide-y divide-gray-200">
            ...
            <div class="p-4 hover:bg-gray-50">
                ...
                <div class="flex flex-wrap gap-2 text-xs mb-2">
                    ...
                    <span class="text-gray-600">{{ \Carbon\Carbon::parse($leave->start_date)->format('d M Y') }} - {{ \Carbon\Carbon::parse($leave->end_date)->format('d M Y') }}</span>
                    <span class="font-semibold text-gray-900">{{ $leave->total_days }} hari</span>
                </div>
                <a href="{{ route('approvals.leaves.show', $leave->id) }}" class="text-blue-600 text-xs font-medium">Review <i class="fas fa-arrow-right ml-1"></i></a>
            </div>
            @empty
