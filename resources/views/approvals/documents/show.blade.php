...
<div class="space-y-6" x-data="{ showVerifyModal: false, showRejectModal: false, rejectionReason: '' }">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex gap-2">
            <button @click="showVerifyModal = true" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition inline-flex items-center"><i class="fas fa-check mr-2"></i>Verifikasi</button>
            <button @click="showRejectModal = true" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition inline-flex items-center"><i class="fas fa-times mr-2"></i>Tolak</button>
        </div>
        @endif
    </div>
