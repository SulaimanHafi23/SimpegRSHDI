            ...
            <div class="flex flex-wrap items-center gap-2">
                <x-export-buttons :route="route('employee.shift-swaps.export')" title="Export Tukar Shift">
                    <div>
                        ...
                        <select name="partner_id" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
