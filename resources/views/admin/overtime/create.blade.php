    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center text-sm text-gray-600 mb-4">
                ...
                <span class="text-gray-800">Input Lembur</span>
            </div>
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Form Input Lembur</h1>
            <p class="text-gray-600 mt-1">Lengkapi form di bawah untuk input data lembur</p>
        </div>
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="reason" 
                                  ...
                                  placeholder="Jelaskan alasan/kegiatan lembur...">{{ old('reason') }}</textarea>
                        @error('reason')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
