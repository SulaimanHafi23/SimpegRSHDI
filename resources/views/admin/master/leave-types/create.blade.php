...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.master.leave-types.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="code" 
                           value="{{ old('code') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 @error('code') border-red-500 @enderror"
                           placeholder="CT-001"
                           required>
                    @error('code')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" name="requires_attachment" value="1" {{ old('requires_attachment', false) ? 'checked' : '' }}
                               class="w-4 h-4 text-green-600 border-gray-300 rounded">
