            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <input type="checkbox" id="per_day_enabled" name="per_day_enabled" value="1" {{ old('per_day_enabled') ? 'checked' : '' }} class="w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
