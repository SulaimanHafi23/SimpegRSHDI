...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Edit Agama</h1>
            <p class="text-sm text-gray-600 mt-1">Ubah data agama</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.master.religions.update', $religion->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
