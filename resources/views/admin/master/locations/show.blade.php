...
<div class="space-y-4 sm:space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-2">
            ...
            <form action="{{ route('admin.master.locations.destroy', $location->id) }}" method="POST" onsubmit="return confirm('Yakin hapus?')">
                @csrf
                @method('DELETE')
    ...
    <div class="bg-white rounded-lg shadow p-4 sm:p-6">
        ...
        <div class="border-t pt-6 grid grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-xl sm:text-2xl font-bold text-red-600">{{ $location->workers_count ?? 0 }} orang</p>
            </div>
            <div>
