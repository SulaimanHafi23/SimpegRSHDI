...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Data Lokasi</h1>
            <p class="text-sm text-gray-600 mt-1">Kelola data lokasi kerja</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-4">
        <form method="GET" class="flex gap-3">
            ...
            @if($keyword ?? false)
            <a href="{{ route('admin.master.locations.index') }}" class="px-6 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg">
                Reset
            </a>
            @endif
        </form>
