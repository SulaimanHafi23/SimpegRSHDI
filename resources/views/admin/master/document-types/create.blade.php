        ...
        <form action="{{ route('admin.master.document-types.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="pdf" 
                                   {{ in_array('pdf', old('file_formats', ['pdf', 'jpg', 'png'])) ? 'checked' : '' }}
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="jpg" 
                                   {{ in_array('jpg', old('file_formats', ['pdf', 'jpg', 'png'])) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="jpeg" 
                                   {{ in_array('jpeg', old('file_formats', [])) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="png" 
                                   {{ in_array('png', old('file_formats', ['pdf', 'jpg', 'png'])) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="doc" 
                                   {{ in_array('doc', old('file_formats', [])) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="file_formats[]" value="docx" 
                                   {{ in_array('docx', old('file_formats', [])) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <input type="hidden" name="file_format" id="file_format_hidden" value="{{ old('file_format', 'pdf,jpg,png') }}">
                    @error('file_format')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    @error('file_formats')
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center space-x-3">
                            <input type="number" 
                                   ...
                                   max="100" 
                                   step="0.1"
                                   value="{{ old('max_file_size_mb', old('max_file_size') ? round(old('max_file_size') / 1024, 1) : 2) }}"
