...
<div class="w-full">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
            ...
            <span class="text-gray-900 font-medium">Edit Libur</span>
        </div>
        ...
        <form action="{{ route('admin.holidays.update', $holiday->id) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_national" id="is_national" value="1" {{ old('is_national', $holiday->is_national) ? 'checked' : '' }}
