...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-0">
        <div>
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Manajemen Cuti</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $statistics['rejected'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-gray-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $statistics['cancelled'] ?? 0 }}</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form method="GET" action="{{ route('admin.leave.index') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="leave_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500">
                        <option value="">Semua Jenis</option>
                        @foreach($leaveTypes as $type)
                            <option value="{{ $type }}" {{ $filters['leave_type'] == $type ? 'selected' : '' }}>
                                {{ $type }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="month" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <select name="year" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                ...
                                $config = $statusConfig[$leave->status] ?? ['bg' => 'bg-gray-100', 'text' => 'text-gray-800'];
                            @endphp
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                            ...
                            <p class="mt-2">Tidak ada data pengajuan cuti</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
