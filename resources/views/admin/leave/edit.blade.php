...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Edit Pengajuan Cuti</h1>
            <p class="text-gray-600 mt-1">Perbarui informasi pengajuan cuti</p>
        </div>
