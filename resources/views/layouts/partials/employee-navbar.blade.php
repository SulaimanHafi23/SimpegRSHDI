    ...
    <div class="px-4 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <!-- Notifications -->
                <button class="relative p-2 transition duration-200 rounded-lg hover:bg-green-500">
                    <i class="text-xl fas fa-bell"></i>
                    <span class="absolute w-2 h-2 bg-yellow-400 rounded-full top-1 right-1 animate-pulse"></span>
                </button>
