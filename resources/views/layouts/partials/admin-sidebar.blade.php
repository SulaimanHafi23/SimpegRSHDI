    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto" x-data="{
        ...
        <div class="pt-3">
            ...
            <div x-show="openMenu === 'approval'" x-collapse class="ml-4 mt-2 space-y-1">
                ...
                @endif
                @if(auth()->user()->can('dashboard.admin') || auth()->user()->can('shift-swap.manage'))
                ...
                @endif
                @if(auth()->user()->can('dashboard.admin') || auth()->user()->can('dashboard.hr'))
        ...
        <div class="pt-3">
            ...
            <div x-show="openMenu === 'admin'" x-collapse class="ml-4 mt-2 space-y-1">
                @if(auth()->user()->can('dashboard.admin') || auth()->user()->can('holiday.manage'))
