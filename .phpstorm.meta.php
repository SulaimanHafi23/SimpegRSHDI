...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Semester 5\PKL\SimpegRSHDI\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Semester 5\\PKL\\SimpegRSHDI\\public\\storage','logging.default',
...
'boost.browser-logs','sanctum.csrf-cookie','home','login',
'login.post','register','register.post','password.request','password.email',
'password.reset','password.update','logout','dashboard','admin.dashboard',
'admin.master.religions.index','admin.master.religions.create','admin.master.religions.store','admin.master.religions.show','admin.master.religions.edit',
'admin.master.religions.update','admin.master.religions.destroy','admin.master.genders.index','admin.master.genders.create','admin.master.genders.store',
'admin.master.genders.show','admin.master.genders.edit','admin.master.genders.update','admin.master.genders.destroy','admin.master.positions.index',
'admin.master.positions.create','admin.master.positions.store','admin.master.positions.show','admin.master.positions.edit','admin.master.positions.update',
'admin.master.positions.destroy','admin.master.locations.index','admin.master.locations.create','admin.master.locations.store','admin.master.locations.show',
'admin.master.locations.edit','admin.master.locations.update','admin.master.locations.destroy','admin.master.document-types.index','admin.master.document-types.create',
'admin.master.document-types.store','admin.master.document-types.show','admin.master.document-types.edit','admin.master.document-types.update','admin.master.document-types.destroy',
'admin.settings.file-requirements.index','admin.settings.file-requirements.create','admin.settings.file-requirements.store','admin.settings.file-requirements.show','admin.settings.file-requirements.edit',
'admin.settings.file-requirements.update','admin.settings.file-requirements.destroy','admin.settings.shifts.index','admin.settings.shifts.create','admin.settings.shifts.store',
'admin.settings.shifts.show','admin.settings.shifts.edit','admin.settings.shifts.update','admin.settings.shifts.destroy','admin.settings.shift-patterns.index',
'admin.settings.shift-patterns.create','admin.settings.shift-patterns.store','admin.settings.shift-patterns.show','admin.settings.shift-patterns.edit','admin.settings.shift-patterns.update',
'admin.settings.shift-patterns.destroy','admin.settings.roles.index','admin.settings.roles.create','admin.settings.roles.store','admin.settings.roles.show',
'admin.settings.roles.edit','admin.settings.roles.update','admin.settings.roles.destroy','admin.settings.permissions.index','admin.settings.permissions.create',
'admin.settings.permissions.edit','admin.workers.index','admin.workers.create','admin.workers.store','admin.workers.show',
'admin.workers.edit','admin.workers.update','admin.workers.destroy','admin.workers.schedule','admin.workers.schedule.update',
'admin.workers.import','admin.workers.import.post','admin.workers.export','admin.attendance.index','admin.attendance.show',
'admin.attendance.report','admin.attendance.export','admin.approvals.leaves.index','admin.approvals.leaves.show','admin.approvals.leaves.approve',
'admin.approvals.leaves.reject','admin.approvals.overtimes.index','admin.approvals.overtimes.show','admin.approvals.overtimes.approve','admin.approvals.overtimes.reject',
'admin.approvals.business-trips.index','admin.approvals.business-trips.show','admin.approvals.business-trips.approve','admin.approvals.business-trips.reject','admin.approvals.business-trips.report.review',
'admin.approvals.documents.index','admin.approvals.documents.show','admin.approvals.documents.verify','admin.approvals.documents.reject','admin.payroll.index',
'admin.payroll.create','admin.payroll.store','admin.payroll.show','admin.payroll.edit','admin.payroll.update',
'admin.payroll.generate','admin.payroll.export','admin.reports.attendance','admin.reports.leaves','admin.reports.overtimes',
'admin.reports.business-trips','admin.reports.payroll','employee.dashboard','employee.attendance.index','employee.attendance.create',
'employee.attendance.store','employee.attendance.show','employee.schedule.index','employee.schedule.calendar','employee.requests.leaves.index',
'employee.requests.leaves.create','employee.requests.leaves.store','employee.requests.leaves.show','employee.requests.leaves.edit','employee.requests.leaves.update',
'employee.requests.leaves.destroy','employee.requests.overtimes.index','employee.requests.overtimes.create','employee.requests.overtimes.store','employee.requests.overtimes.show',
'employee.requests.overtimes.edit','employee.requests.overtimes.update','employee.requests.overtimes.destroy','employee.requests.business-trips.index','employee.requests.business-trips.create',
'employee.requests.business-trips.store','employee.requests.business-trips.show','employee.requests.business-trips.edit','employee.requests.business-trips.update','employee.requests.business-trips.report.create',
'employee.requests.business-trips.report.store','employee.requests.business-trips.report.edit','employee.requests.business-trips.report.update','employee.documents.index','employee.documents.upload',
'employee.documents.store','employee.documents.show','employee.documents.destroy','employee.payroll.index','employee.payroll.show',
'employee.profile.index','employee.profile.edit','employee.profile.update','employee.profile.change-password','employee.profile.change-password.update',
'storage.local',);
        registerArgumentsSet('views', 
'admin.approvals.business-trips.approve','admin.approvals.business-trips.index','admin.approvals.business-trips.reject','admin.approvals.business-trips.report-review','admin.approvals.business-trips.show',
'admin.approvals.documents.index','admin.approvals.documents.reject','admin.approvals.documents.show','admin.approvals.documents.verify','admin.approvals.leaves.approve',
'admin.approvals.leaves.index','admin.approvals.leaves.reject','admin.approvals.leaves.show','admin.approvals.overtimes.approve','admin.approvals.overtimes.index',
'admin.approvals.overtimes.reject','admin.approvals.overtimes.show','admin.attendance.export','admin.attendance.index','admin.attendance.report',
'admin.attendance.show','admin.dashboard.index','admin.master.document-types.create','admin.master.document-types.edit','admin.master.document-types.index',
'admin.master.document-types.show','admin.master.genders.create','admin.master.genders.edit','admin.master.genders.index','admin.master.genders.show',
'admin.master.locations.create','admin.master.locations.edit','admin.master.locations.index','admin.master.locations.show','admin.master.positions.create',
'admin.master.positions.edit','admin.master.positions.index','admin.master.positions.show','admin.master.religions.create','admin.master.religions.edit',
'admin.master.religions.index','admin.master.religions.show','admin.payroll.create','admin.payroll.edit','admin.payroll.export',
'admin.payroll.generate','admin.payroll.index','admin.payroll.show','admin.reports.attendance','admin.reports.business-trips',
'admin.reports.leaves','admin.reports.overtimes','admin.reports.payroll','admin.settings.file-requirements.create','admin.settings.file-requirements.edit',
'admin.settings.file-requirements.index','admin.settings.file-requirements.show','admin.settings.permissions.create','admin.settings.permissions.edit','admin.settings.permissions.index',
'admin.settings.roles.create','admin.settings.roles.edit','admin.settings.roles.index','admin.settings.roles.show','admin.settings.shift-patterns.create',
'admin.settings.shift-patterns.edit','admin.settings.shift-patterns.index','admin.settings.shift-patterns.show','admin.settings.shifts.create','admin.settings.shifts.edit',
'admin.settings.shifts.index','admin.settings.shifts.show','admin.workers.create','admin.workers.edit','admin.workers.export',
'admin.workers.import','admin.workers.index','admin.workers.schedule','admin.workers.show','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','components.forms.checkbox',
'components.forms.datepicker','components.forms.error','components.forms.file-upload','components.forms.input','components.forms.label',
'components.forms.radio','components.forms.select','components.forms.textarea','components.forms.timepicker','components.status-badge',
'components.ui.alert','components.ui.badge','components.ui.breadcrumb','components.ui.button','components.ui.card',
'components.ui.empty-state','components.ui.loading','components.ui.modal','components.ui.pagination','components.ui.table',
'dashboard','emails.leave-approved','emails.leave-rejected','emails.overtime-approved','emails.payroll-notification',
'emails.welcome','employee.attendance.create','employee.attendance.index','employee.attendance.show','employee.dashboard.index',
'employee.documents.index','employee.documents.show','employee.documents.upload','employee.payroll.index','employee.payroll.show',
'employee.profile.change-password','employee.profile.edit','employee.profile.index','employee.requests.business-trips.create','employee.requests.business-trips.edit',
'employee.requests.business-trips.index','employee.requests.business-trips.report-create','employee.requests.business-trips.report-edit','employee.requests.business-trips.show','employee.requests.leaves.create',
'employee.requests.leaves.edit','employee.requests.leaves.index','employee.requests.leaves.show','employee.requests.overtimes.create','employee.requests.overtimes.edit',
'employee.requests.overtimes.index','employee.requests.overtimes.show','employee.schedule.calendar','employee.schedule.index','errors.403',
'errors.404','errors.500','errors.503','layouts.admin','layouts.app',
'layouts.employee','layouts.guest','layouts.partials.admin-footer','layouts.partials.admin-navbar','layouts.partials.admin-sidebar',
'layouts.partials.employee-footer','layouts.partials.employee-navbar','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.Semester 5.PKL.SimpegRSHDI.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
