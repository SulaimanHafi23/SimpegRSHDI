...
class LeaveRequestNotification extends Notification implements ShouldQueue
{
    ...
    {
        $startDate = \Illuminate\Support\Carbon::parse($this->leaveRequest->start_date)->format('d/m/Y');
        $endDate = \Illuminate\Support\Carbon::parse($this->leaveRequest->end_date)->format('d/m/Y');
