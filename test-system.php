...
$tables = ['users', 'workers', 'roles', 'permissions', 'departments', 'locations', 'shifts', 'attendances', 'worker_shifts', 'leave_requests', 'overtime_requests', 'worker_documents', 'payrolls', 'holidays'];
